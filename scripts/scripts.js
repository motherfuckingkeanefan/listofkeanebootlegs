...
const recordings = [
    ...
    { date: "2004-06-24", city: "New York", venue: "WXRK Studios", source: "Excellent (FM)", length: 5, equipment: "FM > WAV > FLAC" },
    { date: "2004-06-26", city: "Pilton", venue: "Glastonbury Festival (Other Stage)", source: "Excellent (FM)", length: 40, equipment: "Digital Satellite Receiver > CDR > FLAC" },
    { date: "2004-06-26", city: "Pilton", venue: "Glastonbury Festival (Backstage Session)", source: "Excellent (FM)", length: 10, equipment: "Digital Satellite Receiver > CDR > FLAC" },
    { date: "2004-07-04", city: "Herzogenrath", venue: "Eins Live Konigstreffen", source: "Excellent (FM)", length: 40, equipment: "FM > DAT > FLAC" },
    { date: "2004-07-11", city: "Punchestown", venue: "Oxegen Festival", source: "Poor (Audience)", length: 40, equipment: "AUD > CDR > FLAC" },
    { date: "2004-07-11", city: "Punchestown", venue: "Oxegen Festival", source: "Excellent (FM)", length: 30, equipment: "FM > CDR > FLAC" },
    { date: "2004-07-16", city: "Arvika", venue: "Arvikafestivalen", source: "Excellent (FM)", length: 50, equipment: "Analogue Cable FM > WAV > FLAC" },
    ...
    { date: "2004-08-18", city: "Battle", venue: "Battle Memorial Hall", source: "Excellent (Soundboard)", length: 40, equipment: "SBD > CDR > FLAC" },
    ...
    { date: "2004-08-20", city: "Biddinghuizen", venue: "Lowlands Festival", source: "Excellent (Soundboard)", length: 30, equipment: "SBD > CDR > FLAC" },
    { date: "2004-08-21", city: "Chelmsford", venue: "V Festival (Backstage Session)", source: "Excellent (FM)", length: 10, equipment: "Digital Satellite Receiver > CDR > FLAC" },
    ...
    { date: "2005-03-23", city: "Amsterdam", venue: "Heineken Music Hall", source: " Excellent (Soundboard)", length: 75, equipment: "SBD > CDR > FLAC" },
    ...
    { date: "2005-06-25", city: "Pilton", venue: "Glastonbury Festival", source: "Excellent (FM)", length: 25, equipment: "Digital Satellite Receiver > CDR > FLAC" },
    ...
    { date: "2008-11-20", city: "Paris", venue: "Le Zénith", source: "Excellent (Audience)", length: 60, equipment: "SP-CMC-4 > SP-SPSB-1 > Edirol R-09" },
        { date: "2008-11-26", city: "London", venue: "Indigo at The O2", source: "Excellent (FM)", length: 30, equipment: "Digital Satellite Receiver > Yamaha CDR1500 > FLAC" },
...
{ date: "2024-06-21", city: "Landgraaf", venue: "Pinkpop Festival", source: "Excellent (FM)", length: 75, equipment: "Digital Radio Broadcast > WAV > FLAC" },
